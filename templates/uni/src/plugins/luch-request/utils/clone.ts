...
const clone = (function () {
    ...
    function _clone(parent: any, depth: number): any {
      ...
      if (Object.getOwnPropertySymbols) {
        ...
        for (let i = 0; i < symbols.length; i++) {
          ...
          Object.defineProperty(child, symbol, descriptor as PropertyDescriptor)
        }
      }
  ...
  clone.clonePrototype = function clonePrototype(parent: any): any {
    ...
    const c = function (this: any) {} as unknown as {
      new (): any
      prototype: any
    }
    c.prototype = parent

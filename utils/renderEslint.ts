...
export default function renderEslint(
  ...
  if (needsCypress) {
    ...
    additionalDependencies['eslint-plugin-cypress'] =
      eslintDeps['eslint-plugin-cypress']
  }
  ...
  if (needsPlaywright) {
    ...
    additionalDependencies['eslint-plugin-playwright'] =
      eslintDeps['eslint-plugin-playwright']
  }
  ...
  const updatedPkg = sortDependencies(
    deepMerge(deepMerge(existingPkg, pkg), { scripts }),
  )
  fs.writeFileSync(
    packageJsonPath,
